                ...
                {profileOpen && (
                  <>
                    ...
                    <motion.div 
                      ...
                      className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.12)] border border-gray-100 py-2 z-50 origin-top-right overflow-hidden"
                    >
                      ...
                      <div className="py-1">
                        {!user.roles?.some((r) => ["super_admin", "admin"].includes(r)) && (
                          <Link
                            href="/dashboard"
                            className="flex items-center gap-2 px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-colors font-bn"
                            onClick={() => setProfileOpen(false)}
                          >
